Public Class ChooseTerm
    ...
    Private Sub Menu_Add_Click(sender As Object, e As EventArgs) Handles Menu_Add.Click
        ...
        If (UserAccessControls And (2 ^ 4)) = 0 Then MsgBox("قابليت (افزودن) اين آيتم اکنون براي شما غير فعال است", vbInformation, "تنظيمات نکسترم") : Exit Sub
    ...
    Private Sub Menu_Edit_Click(sender As Object, e As EventArgs) Handles Menu_Edit.Click
        ...
        Try
            Select Case c
                Case 1 ' TERM
                    If (Userx = "USER Faculty") And (UserAccessControls And (2 ^ 4) = 0) Then MsgBox("مجوز تغيير نام ترم را نداريد", vbOKOnly, "تنظيمات نکسترم") : Exit Sub
